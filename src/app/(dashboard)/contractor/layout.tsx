/**
 * VOR Phase 2 - Contractor Workspace Layout
 * 
          ...
          <div className="border-t border-vor-navy-light p-4">
            <div className="flex items-center gap-3 rounded-lg bg-vor-navy-light p-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">BuildRight Construction</p>
                <p className="text-xs text-vor-slate">Contractor</p>
              </div>
              <button
      ...
      <main className="ml-64">
        ...
        <header className="sticky top-0 z-30 border-b border-vor-border bg-white px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-vor-navy">Contractor Workspace</h2>
