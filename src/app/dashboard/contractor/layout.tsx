/**
 * VOR Phase 2 - Contractor Dashboard Layout
 *
 * Layout for the contractor dashboard with sidebar navigation
 */
...
const contractorNavItems = [
  ...
  {
    label: 'Deliverables',
    href: '/dashboard/contractor/deliverables',
    icon: FolderOpen,
  },
  {
    label: 'Uploads',
    href: '/dashboard/contractor/uploads',
    icon: Upload,
  },
  {
    label: 'Requests',
          ...
          <div className="border-b border-vor-navy-light p-6">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-vor-slate">Contractor Portal</p>
              </div>
            </Link>
          </div>
          ...
          <div className="border-t border-vor-navy-light p-4">
            <div className="flex items-center gap-3 rounded-lg bg-vor-navy-light p-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Contractor User</p>
                <p className="text-xs text-vor-slate">Construction Partner</p>
              </div>
              <button
      ...
      <main className="ml-64">
        ...
        <header className="sticky top-0 z-30 border-b border-vor-border bg-white px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-vor-navy">Contractor Dashboard</h2>
              <p className="text-sm text-vor-slate">Manage your construction projects</p>
            </div>
