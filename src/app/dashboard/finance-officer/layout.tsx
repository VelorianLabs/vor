/**
 * VOR Phase 2 - Finance Officer Dashboard Layout
 *
 * Layout for the finance officer dashboard with sidebar navigation
 */
...
const financeNavItems = [
  ...
  {
    label: 'Transactions',
    href: '/dashboard/finance-officer/transactions',
    icon: ArrowRightLeft,
  },
  {
    label: 'Invoices',
    href: '/dashboard/finance-officer/invoices',
    icon: FileText,
  },
  {
    label: 'Reports',
          ...
          <div className="border-b border-vor-navy-light p-6">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-vor-slate">Finance Portal</p>
              </div>
            </Link>
          </div>
          ...
          <div className="border-t border-vor-navy-light p-4">
            <div className="flex items-center gap-3 rounded-lg bg-vor-navy-light p-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Finance User</p>
                <p className="text-xs text-vor-slate">Finance Officer</p>
              </div>
              <button
      ...
      <main className="ml-64">
        ...
        <header className="sticky top-0 z-30 border-b border-vor-border bg-white px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-vor-navy">Finance Dashboard</h2>
              <p className="text-sm text-vor-slate">Manage transactions and financial reports</p>
            </div>
