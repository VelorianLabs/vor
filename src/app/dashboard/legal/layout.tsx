/**
 * VOR Phase 2 - Legal & Verification Center Layout
 *
...
const legalNavItems = [
  ...
  },
  {
    ...
    href: '/dashboard/legal/verifications',
    icon: FileCheck,
  },
  {
          ...
          <div className="border-b border-vor-navy-light p-6">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-vor-slate">Legal Portal</p>
              </div>
            </Link>
          </div>
            ...
            <ul className="space-y-1">
              {legalNavItems.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium text-white/80 hover:bg-vor-navy-light hover:text-white transition-colors"
                  >
          ...
          <div className="border-t border-vor-navy-light p-4">
            <div className="flex items-center gap-3 rounded-lg bg-vor-navy-light p-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-vor-slate">Legal Officer</p>
              </div>
              <button
      ...
      <main className="ml-64">
        ...
        <header className="sticky top-0 z-30 border-b border-vor-border bg-white px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-vor-navy">Legal & Verification Center</h2>
              <p className="text-sm text-vor-slate">Manage verification requests and legal compliance</p>
            </div>
